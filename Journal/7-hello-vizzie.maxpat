...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 518.0, 339.0, 100.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 687.0, 380.0, 298.0, 130.0 ],
					"prototypename" : "pixl",
...
, 			{
				"box" : 				{
					...
					"data" : 					{
						"clips" : [ 							{
								"absolutepath" : "/Users/kylesmith/Splice/sounds/packs/Rare - Tape Jams 2/Renraku_-_Rare_-_Tape_Jams_Volume_2/Loops/Drum_loops/Full_Drum_Loops/RKU_TJII_60_drum_loop_full_getaway.wav",
								"filename" : "RKU_TJII_60_drum_loop_full_getaway.wav",
								"filekind" : "audiofile",
								"id" : "u677012050",
								"loop" : 1,
								"content_state" : 								{
...
,
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 770.0, 289.0, 271.0, 23.0 ],
					"pitchcorrection" : 0,
					"quality" : "basic",
					"timestretch" : [ 0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 1034.0, 387.0, 148.0, 116.0 ],
					"varname" : "bp.Stereo",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 764.0, 123.0, 177.0, 134.0 ],
					"prototypename" : "pixl",
					"varname" : "startr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 595.0, 559.0, 230.0, 208.0 ],
					"prototypename" : "pixl",
					"varname" : "viewr[2]",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 329.0, 240.0, 128.0, 130.0 ],
					"prototypename" : "pixl",
					"varname" : "pixl8r",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 47.0, 422.0, 230.0, 208.0 ],
					"prototypename" : "pixl",
					"varname" : "viewr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 47.0, 266.0, 208.0, 130.0 ],
					"prototypename" : "pixl",
					"varname" : "brcosr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 88.764052033424377, 54.16854453086853, 348.0, 170.0 ],
					"prototypename" : "pixl",
					"varname" : "avplayr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 417.0, 16.0, 73.0, 22.0 ],
					"text" : "pattrforward"
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-9::obj-20" : [ "letterbox_menu[2]", "letterbox_menu", 0 ],
			"obj-9::obj-37" : [ "aspect_menu[2]", "aspect_menu", 0 ],
			"parameterbanks" : 			{
...
,
		"dependency_cache" : [ 			{
				"name" : "RKU_TJII_60_drum_loop_full_getaway.wav",
				"bootpath" : "~/Splice/sounds/packs/Rare - Tape Jams 2/Renraku_-_Rare_-_Tape_Jams_Volume_2/Loops/Drum_loops/Full_Drum_Loops",
				"patcherrelativepath" : "../../Splice/sounds/packs/Rare - Tape Jams 2/Renraku_-_Rare_-_Tape_Jams_Volume_2/Loops/Drum_loops/Full_Drum_Loops",
				"type" : "WAVE",
				"implicit" : 1
			}
, 			{
